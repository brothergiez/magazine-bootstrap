        ...
        <div class="box-body table-responsive">
            ...
            <table class="table table-hover">
				...
				<tr>
					...
					<td><?php echo ($user->active) ? anchor("deactivate/".$user->id, "<span class='label label-success'>".lang('index_active_link')."</span>") : anchor("activate/". $user->id, "<span class='label label-danger'>".lang('index_inactive_link')."</span>");?></td>
