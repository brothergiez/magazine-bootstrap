<div class="container">
	<div class="row">
		<div class="col-md-12 col-sm-12 title">
			<a href="detail.php">Kurt Cobain</a>
		</div>
		<div class="col-md-12 col-sm-12 detail-article">
			<img src="assets/images/cobain.png" class="img-responsive article-img img-detail">
			<div class="ads-slot-detail">
				<div class="ads">
